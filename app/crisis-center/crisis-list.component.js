...
var CrisisListComponent = (function () {
    function CrisisListComponent(service, router, routeParams) {
    ...
    CrisisListComponent = __decorate([
        ...
        __metadata('design:paramtypes', [crisis_service_1.CrisisService, router_deprecated_1.Router, router_deprecated_1.RouteParams])
    ], CrisisListComponent);
